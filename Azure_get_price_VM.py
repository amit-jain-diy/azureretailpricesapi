...
# region variable: Change this to get price by region
zRegion = 'northeurope'

# Set your file location and filename to save your json and excel file
#change path 
filelocation = "C:/temp/azureretailpricesapi"
filename = "VM_price_usd_" + zRegion

# URL
url = "https://prices.azure.com/api/retail/prices?$filter=serviceName eq 'Virtual Machines' and armRegionName eq " + "'"+ zRegion +"'"

# https://prices.azure.com/api/retail/prices?$filter=serviceName eq 'Virtual Machines' and armRegionName eq 'northeurope'
